...
\end{equation}
Place a source beam of photons of frequency \(f_s\) incident on the atoms, travelling in direction \(+\vec{\hat{x}}\). Due to Doppler shifting, an atom travelling at velocity \(v\vec{\hat{x}}\) relative to the lab frame will observe photons at the frequency
\begin{equation}
...
\begin{figure}[h]
    \centering
    \begin{tikzpicture}
        \draw (0,0) .. controls (1,0) and (2,-2) .. (3,-4);
        \draw (3,-4) .. controls (4,-1) and (5,0) .. (7,0);
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}[node distance=2cm]
        ...
        \draw [->, line width=1pt] (A)--(AArrowEnd);
        \draw [->, line width=1pt] (B)--(BArrowEnd);
    \end{tikzpicture}
